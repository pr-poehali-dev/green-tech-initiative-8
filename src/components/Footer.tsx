export function Footer() {
  const footerLinks = {
    "Услуги": ["Лендинги", "Интернет-магазины", "Корпоративные сайты", "Портфолио", "Блоги", "Редизайн", "Техподдержка"],
    "Технологии": ["React", "TypeScript", "Tailwind CSS", "Next.js", "Node.js", "PostgreSQL", "REST API"],
    "Работа": ["Как заказать", "Тарифы", "Гарантии", "Отзывы", "Портфолио", "FAQ", "Бриф"],
    "Контакты": ["Kwork", "Telegram", "Email", "ВКонтакте", "WhatsApp"],
  }
