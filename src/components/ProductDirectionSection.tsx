    ...
    <section className="relative py-40 px-6 md:px-12 lg:px-24">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-2 mb-6">
          ...
          <span className="text-zinc-400 text-sm">Портфолио и проекты</span>
        ...
        <p className="text-zinc-400 text-lg max-w-md mb-16">
          <span className="text-white font-medium">Каждый проект сдаётся в срок.</span> Смотрите мои работы: лендинги, магазины и корпоративные сайты для реальных клиентов.
        </p>
        ...
        >
          ...
          >
            ...
            <div className="relative h-[400px]">
              ...
              >
                <div className="w-4 h-4 rotate-45 bg-violet-500/60" />
                <span className="text-zinc-300 text-sm font-medium">Интернет-магазин одежды</span>
                <div
              ...
              >
                ...
                <span className="text-zinc-500 text-sm">Лендинг стоматологии</span>
              </div>
              ...
              >
                <span className="text-zinc-400 text-sm">Корпоративный сайт</span>
                <div className="flex gap-0.5">
                  <div className="w-2.5 h-2.5 rotate-45 bg-violet-500/60" />
                  <div className="w-2.5 h-2.5 rotate-45 bg-violet-500/60" />
                  <div className="w-2.5 h-2.5 rotate-45 bg-violet-500/60" />
                </div>
              </div>
              ...
              >
                <span className="text-zinc-400 text-sm">Портфолио фотографа</span>
                <div className="flex gap-0.5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="border-t border-r border-b border-zinc-800 pt-10 pr-10 pb-16">
            <h3 className="text-xl font-medium text-zinc-200 mb-3">Ведём проект от заявки до запуска</h3>
            <p className="text-zinc-500 text-base leading-relaxed mb-8">
              Дизайн, разработка, тестирование и сдача — всё в одном месте под вашим контролем.
            </p>

            <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-5">
              <h4 className="text-lg font-medium text-zinc-200 mb-5">Статус проекта</h4>
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="flex items-center gap-1.5 px-2 py-1 rounded bg-zinc-800 text-zinc-400 text-xs">
                    <span className="text-yellow-500">Лендинг</span>
                  </span>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex flex-col gap-2">
                  <span className="flex items-center gap-2 text-zinc-300 text-sm">
                    <span className="w-2.5 h-2.5 rotate-45 bg-violet-500" />
                    Дизайн-макет <span className="text-zinc-500">100%</span>
                  </span>
                  <span className="flex items-center gap-2 text-zinc-300 text-sm">
                    <span className="w-2.5 h-2.5 rotate-45 bg-violet-500" />
                    Вёрстка <span className="text-zinc-500">100%</span>
                  </span>
                  <span className="flex items-center gap-2 text-zinc-400 text-sm">
                    ...
                    Запуск <span className="text-zinc-500">сдача завтра</span>
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="border-t border-b border-zinc-800 pt-10 pl-10 pb-16">
            <h3 className="text-xl font-medium text-zinc-200 mb-3">Клиент всегда в курсе</h3>
            <p className="text-zinc-500 text-base leading-relaxed mb-8">
              Регулярные обновления и прозрачный статус — вы видите прогресс на каждом этапе.
            </p>
            ...
            <div className="relative h-48">
              ...
              >
                ...
                <p className="text-zinc-300 text-sm mb-3">Сайт готов к запуску завтра!</p>
                <span className="text-zinc-500 text-xs">Сдача в срок ✓</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="border-r border-zinc-800 pt-16 pr-10 pb-16 flex flex-col justify-center">
            ...
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-zinc-200 font-medium">Сдача в срок или возврат</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-1 h-5 rounded-full bg-violet-500/50" />
                <span className="text-zinc-400">Бесплатные правки до приёмки</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-1 h-5 rounded-full bg-violet-500/30" />
                <span className="text-zinc-500">Месяц поддержки после запуска</span>
              </div>
            </div>
          </div>
