...
const agents = [
  ...
  { name: "Интернет-магазин", isAgent: true, selected: false, icon: "◉" },
  { name: "Корпоративный сайт", isAgent: true, selected: false, icon: "◈" },
  { name: "Блог / Портфолио", isAgent: false, selected: false, icon: "○" },
  { name: "SEO-продвижение", isAgent: true, selected: false, icon: "◎" },
  { name: "Техподдержка", isAgent: false, selected: false, icon: "○" },
]
    ...
    <div className="relative z-20 py-40" style={{ backgroundColor: "#09090B" }}>
      ...
      <div className="w-full flex justify-center px-6">
        <div className="w-full max-w-5xl">
          ...
          >
            <span className="text-white font-medium">Под ключ за разумные деньги.</span> Разработка сайтов любой сложности: от простой визитки до полноценного интернет-магазина.
          </motion.p>
                    ...
                    >
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          {agent.isAgent && (
                            <span className="text-xs bg-violet-900/60 text-violet-300 px-2 py-0.5 rounded">Популярное</span>
                          )}
                        </div>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="border-t border-r border-b border-zinc-800/60 pt-12 pr-12 pb-16">
                <h3 className="text-zinc-200 font-medium text-xl mb-3">Как я работаю</h3>
                <p className="text-zinc-500 text-base mb-8">
                  Простой процесс: заявка — бриф — дизайн — разработка — сдача. Всё чётко и в срок.
                </p>

                {/* Process Card */}
                <div className="bg-zinc-900/30 border border-zinc-800/60 rounded-xl p-5">
                  <div className="flex items-center gap-2 mb-5">
                    <svg className="w-4 h-4 text-violet-400" viewBox="0 0 16 16" fill="currentColor">
                      <path d="M8 0L9.5 5.5L15 7L9.5 8.5L8 14L6.5 8.5L1 7L6.5 5.5L8 0Z" />
                    </svg>
                    <span className="text-zinc-500 text-sm">
                      Этапы <span className="text-zinc-300">работы</span>
                    </span>
                  </div>

                  <div className="flex items-center gap-3 mb-3">
                    <span className="text-zinc-600 text-sm w-20">Шаг 1</span>
                    <div className="flex items-center gap-2">
                      ...
                      >
                        ...
                        <span className="text-white">Заявка</span>
                      </span>
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    <span className="text-zinc-600 text-sm w-20">Шаг 2</span>
                    <span className="text-zinc-500 text-sm">Дизайн и макет</span>
                  </div>

                  <div className="flex items-center gap-3 mb-4">
                    <span className="text-zinc-600 text-sm w-20">Шаг 3</span>
                    <span className="text-zinc-500 text-sm">Разработка и тест</span>
                  </div>

                  <div className="bg-zinc-800/40 rounded-lg p-4 ml-4">
                    <div className="flex items-center gap-2 mb-3">
                      <span className="w-5 h-5 bg-violet-600 rounded-full" />
                      <span className="text-zinc-300 text-sm font-medium">Сдача проекта</span>
                    </div>

                    <p className="text-zinc-500 text-xs mb-2">Что вы получаете</p>
                    <p className="text-zinc-500 text-sm mb-4">
                      Готовый сайт с исходниками, инструкцией и месяцем бесплатной поддержки
                    </p>

                    <p className="text-zinc-500 text-xs mb-2">Гарантии</p>
                    <div className="flex items-center gap-2 mb-4">
                      <span className="flex items-center gap-1.5 bg-zinc-700/50 rounded-md px-2 py-1 text-sm">
                        <span className="w-4 h-4 bg-green-500/60 rounded-full" />
                        <span className="text-zinc-400">В срок</span>
                      </span>
                      <span className="flex items-center gap-1.5 bg-zinc-700/50 rounded-md px-2 py-1 text-sm">
                        <span className="w-4 h-4 bg-violet-500/60 rounded-full" />
                        <span className="text-zinc-400">Правки бесплатно</span>
                      </span>
                    </div>

                    <button className="w-full flex items-center justify-center gap-2 bg-violet-700/50 hover:bg-violet-600/50 text-zinc-300 text-sm py-2.5 rounded-md transition-colors">
              ...
              <div className="border-t border-b border-zinc-800/60 pt-12 pl-12 pb-16">
                <h3 className="text-zinc-200 font-medium text-xl mb-3">Тарифы</h3>
                <p className="text-zinc-500 text-base mb-8">
                  Фиксированные цены без скрытых доплат. Оплата частями.
                </p>

                <div className="bg-zinc-900/30 border border-zinc-800/60 rounded-xl p-5 font-mono text-sm">
                  <p className="text-zinc-700 mb-3">// тарифы webkwork</p>
                  <div className="space-y-1 mb-6">
                    <p>
                      <span className="text-violet-400/70">"лендинг"</span>
                      <span className="text-zinc-500">: </span>
                      <span className="text-green-400/70">"от 5 000 ₽"</span>
                    </p>
                    <p>
                      <span className="text-violet-400/70">"магазин"</span>
                      <span className="text-zinc-500">: </span>
                      <span className="text-green-400/70">"от 15 000 ₽"</span>
                    </p>
                    <p>
                      <span className="text-violet-400/70">"корпоратив"</span>
                      <span className="text-zinc-500">: </span>
                      <span className="text-green-400/70">"от 10 000 ₽"</span>
                    </p>
                  </div>

                  <div className="bg-zinc-800/40 rounded-lg p-4">
                    <div className="flex items-center gap-2 mb-4">
                      <span className="w-0.5 h-5 bg-violet-600" />
                      <span className="text-zinc-600">Что хотите заказать?</span>
                    </div>
