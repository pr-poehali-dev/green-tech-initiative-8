...
const carouselCards = [
  {
    id: 1,
    category: "Заявка от клиента",
    title: "Обсудим детали и сделаем бриф",
    icon: ArrowRight,
    mockup: "intercom",
  },
  {
    id: 2,
    category: "Git + деплой",
    title: "Сайт всегда под контролем версий",
    icon: Plus,
    mockup: "github",
  },
  {
    ...
    title: "Каждый сайт адаптирован под телефон",
    icon: ArrowRight,
    mockup: "mobile",
  },
  {
  ...
  },
  {
    id: 5,
    category: "Интеграции",
    title: "CRM, аналитика, онлайн-оплата",
    icon: ArrowRight,
    mockup: "integrations",
  },
  {
    id: 6,
    category: "Дизайн в Figma",
    title: "Макет согласуем до разработки",
    icon: ArrowRight,
    mockup: "figma",
  },
  {
    ...
    title: "Подключу любой сервис к сайту",
    icon: ArrowRight,
    mockup: "api",
  },
]
  ...
  return (
    <div className="flex flex-col gap-3 p-4">
      <div className="flex items-center gap-2 text-xs text-zinc-400">
        ...
        <span className="text-zinc-500">client@example.com</span>
      </div>
      <p className="text-sm text-zinc-300">
        Нужен сайт для кафе <span className="text-zinc-500">с меню...</span>
      </p>

      <div className="mt-2 flex items-center gap-2 bg-zinc-800/50 rounded-lg px-3 py-2">
        <div className="w-5 h-5 bg-violet-700 rounded flex items-center justify-center">
          <span className="text-[10px] text-white">К</span>
        </div>
        <span className="text-sm text-zinc-300">Кафе "Уют"</span>
        <span className="text-xs text-zinc-500">Новая заявка</span>
      </div>
      ...
      <div className="mt-1 flex items-center gap-2 bg-zinc-800/30 rounded-lg px-3 py-2">
        ...
        <span className="text-sm text-zinc-400">Лендинг</span>
        <span className="text-xs text-zinc-500">+ форма брони</span>
      </div>
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 mb-16">
          <div className="lg:max-w-xl">
            ...
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-sm text-zinc-400">Как устроена работа</span>
          ...
          <p className="text-zinc-400 lg:max-w-sm lg:pt-12">
            Прозрачная работа на каждом шаге: от идеи до запуска. Вы всегда знаете, что происходит с вашим проектом.
          </p>
        </div>
